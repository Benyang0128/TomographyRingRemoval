 ...
 */
 ...
 private:
	...
	int findMinDistanceToEdgeOMP(float center_x, float center_y, int width, int height);
 public:
	ImageTransformClass();
	~ImageTransformClass();
	...
	float** polarTransformOMP(float** image, float center_x, float center_y, int width, int height,
                               int* pol_width, int* pol_height, float thresh_max, float thresh_min,
                               int r_scale, int ang_scale, int overhang);
	...
	float** inversePolarTransformOMP(float** polar_image, float center_x, float center_y,
                                      int pol_width, int  pol_height, int width, int height,
                                      int r_scale, int over_hang);
