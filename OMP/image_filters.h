 ...
 */
 ...
 private:
	...
	int partition2ArraysOMP(float* median_array, int* position_array, int left, int right, int pivot_index);
	...
	void quickSort2ArraysOMP(float* median_array, int* position_array, int left, int right);
 ...
 public:
	...
	void doMedianFilterFast1D(float *** filtered_image, float*** image, int start_row, int start_col,
						  int end_row, int end_col, char axis, int kernel_rad, int filter_width,
						  int width, int height);
	void doMedianFilterFast1DOMP(float *** filtered_image, float*** image, int start_row, int start_col,
						  int end_row, int end_col, char axis, int kernel_rad, int filter_width,
						  int width, int height);
	void doMeanFilterFast1DOMP(float*** filtered_image, float*** image, int start_row, int start_col,
